<?php
namespace HealthySmilesSpace\Woocommerce\CmsmastersFramework;
...
use HealthySmilesSpace\Woocommerce\CmsmastersFramework\Kits\Kit as Plugin_Kit;
...
class Plugin {
	...
	public function before_content_import_setup() {
		if ( 'done' === get_transient( 'cmsmasters_healthy-smiles_remove_woocommerce_pages' ) ) {
			return;
		}
		...
		set_transient( 'cmsmasters_healthy-smiles_remove_woocommerce_pages', 'done', HOUR_IN_SECONDS );
	}
	...
	public function after_content_import_setup() {
		...
		delete_transient( 'cmsmasters_healthy-smiles_remove_woocommerce_pages' );
	}
