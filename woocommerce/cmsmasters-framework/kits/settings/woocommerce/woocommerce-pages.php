<?php
namespace HealthySmilesSpace\Woocommerce\CmsmastersFramework\Kits\Settings\Woocommerce;

use HealthySmilesSpace\Kits\Settings\Base\Settings_Tab_Base;
...
class Woocommerce_Pages extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'WooCommerce Pages', 'healthy-smiles' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			...
			array(
				'raw' => esc_html__( 'Select the pages you want to use as your default WooCommerce shop pages', 'healthy-smiles' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Cart', 'healthy-smiles' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'healthy-smiles' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Checkout', 'healthy-smiles' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'healthy-smiles' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'My Account', 'healthy-smiles' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'healthy-smiles' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Terms & Conditions', 'healthy-smiles' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'healthy-smiles' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Purchase Summary', 'healthy-smiles' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'healthy-smiles' ),
				),
		...
		$this->add_control(
			...
			array(
				'type' => Controls_Manager::RAW_HTML,
				'raw' => esc_html__( 'Note: Changes you make here will also be reflected in the WooCommerce settings on your WP dashboard', 'healthy-smiles' ),
