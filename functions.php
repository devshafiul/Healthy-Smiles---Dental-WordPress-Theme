...
define( 'CMSMASTERS_THEME_VERSION', '1.1.4' );

// CMSMasters API
define( 'CMSMASTERS_API_ROUTES_URL', 'http://api.cmsmasters.net/wp-json/cmsmasters-api/v1/' );

// Theme options
define( 'CMSMASTERS_OPTIONS_PREFIX', 'cmsmasters_healthy-smiles_' );
define( 'CMSMASTERS_OPTIONS_NAME', 'cmsmasters_healthy-smiles_options' );
