...
class Utils {
	...
	public static function get_demo() {
		if ( ! self::$demo_key ) {
			self::$demo_key = get_option( 'cmsmasters_healthy-smiles_demo', 'main' );
		}
	...
	public static function set_demo( $demo_key ) {
		update_option( 'cmsmasters_healthy-smiles_demo', $demo_key );
	...
	public static function get_demo_kit() {
		if ( ! self::$demo_kit_key ) {
			self::$demo_kit_key = get_option( 'cmsmasters_healthy-smiles_demo_kit', 'main' );
		}
	...
	public static function set_demo_kit( $demo_kit_key ) {
		update_option( 'cmsmasters_healthy-smiles_demo_kit', $demo_kit_key );
	...
	public static function get_theme_options() {
		return get_option( 'cmsmasters_healthy-smiles_options', array() );
	}
	...
	public static function set_theme_option( $key, $value ) {
		...
		update_option( 'cmsmasters_healthy-smiles_options', $options );
	}
	...
	public static function get_default_kits() {
		if ( ! self::$default_kits ) {
			self::$default_kits = get_option( 'cmsmasters_healthy-smiles_default_kits', array() );
		}
