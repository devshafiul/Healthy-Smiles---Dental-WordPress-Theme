...
class General_Elements {
	...
	public static function get_logo( $atts = array() ) {
		...
		$logo_title = ( get_bloginfo( 'name' ) ? get_bloginfo( 'name' ) : esc_html__( 'Site logo', 'healthy-smiles' ) );
	...
	public static function get_sub_pagination() {
		return wp_link_pages( array(
			'before' => '<div class="cmsmasters-subpage-nav"><span class="cmsmasters-subpage-nav__title">' . esc_html__( 'Pages', 'healthy-smiles' ) . ':</span><div class="cmsmasters-subpage-nav__items">',
			'after' => '</div></div>',
			'link_before' => '<span>',
			'link_after' => '</span>',
			'echo' => false,
	...
	public static function get_search_form( $plugin = false ) {
		...
		$placeholder_text = ( 'woocommerce' === $plugin ? esc_html__( 'Search products&hellip;', 'healthy-smiles' ) : esc_html__( 'Search...', 'healthy-smiles' ) );
